...
# ── Drop list = selezione E6 su OpenMove (SSOT: thesis/feature_selection.md) ─────
# 67 feature droppate: 230 → 163 (= 148 KEEP + 15 FLAG transfer-risk). Categorie E6 (non-supervisionate):
#   constant/near-constant · always-NaN · too-sparse (>80% NaN GPS-present) · redundant (Spearman≥0.95).
# Ri-derivabile: python thesis/analysis/e6_feature_select.py → thesis/figures/e6_feature_audit.csv.
# (Sostituisce il vecchio DROP_LIST SHL-derived Spearman≥0.85, stale su OpenMove — feature_selection §5.)
DROP_LIST: dict[str, str] = {
    'A_acc_angle_iqr':          'redundant (Spearman>=0.95)',
    'A_acc_angle_mean':         'redundant (Spearman>=0.95)',
    'A_acc_angle_p95':          'redundant (Spearman>=0.95)',
    'A_acc_angle_std':          'redundant (Spearman>=0.95)',
    'A_acc_d2v_iqr':            'redundant (Spearman>=0.95)',
    'A_acc_d2v_mean':           'redundant (Spearman>=0.95)',
    'A_acc_eig3':               'redundant (Spearman>=0.95)',
    'A_acc_eig_entropy':        'redundant (Spearman>=0.95)',
    'A_acc_eig_ratio':          'redundant (Spearman>=0.95)',
    'A_acc_eig_spheric':        'redundant (Spearman>=0.95)',
    'A_acc_mag_kurt':           'redundant (Spearman>=0.95)',
    'A_acc_mag_mean':           'redundant (Spearman>=0.95)',
    'A_acc_mag_p25':            'redundant (Spearman>=0.95)',
    'A_acc_mag_std':            'redundant (Spearman>=0.95)',
    'A_acc_mag_zcr':            'near-constant',
    'A_gyr_acc_ratio':          'redundant (Spearman>=0.95)',
    'A_gyr_d2v_mean':           'redundant (Spearman>=0.95)',
    'A_gyr_d2v_std':            'redundant (Spearman>=0.95)',
    'A_gyr_eig1':               'redundant (Spearman>=0.95)',
    'A_gyr_eig2':               'redundant (Spearman>=0.95)',
    'A_gyr_eig3':               'redundant (Spearman>=0.95)',
    'A_gyr_eig_entropy':        'redundant (Spearman>=0.95)',
    'A_gyr_mag_kurt':           'redundant (Spearman>=0.95)',
    'A_gyr_mag_mean':           'redundant (Spearman>=0.95)',
    'A_gyr_mag_rms':            'redundant (Spearman>=0.95)',
    'A_gyr_mag_std':            'redundant (Spearman>=0.95)',
    'A_gyr_x_rms':              'redundant (Spearman>=0.95)',
    'A_gyr_x_std':              'redundant (Spearman>=0.95)',
    'A_gyr_y_iqr':              'redundant (Spearman>=0.95)',
    'A_gyr_y_rms':              'redundant (Spearman>=0.95)',
    'A_gyr_y_std':              'redundant (Spearman>=0.95)',
    'A_gyr_z_iqr':              'redundant (Spearman>=0.95)',
    'A_gyr_z_rms':              'redundant (Spearman>=0.95)',
    'A_gyr_z_std':              'redundant (Spearman>=0.95)',
    'A_jerk_kurt':              'redundant (Spearman>=0.95)',
    'A_jerk_mean':              'redundant (Spearman>=0.95)',
    'A_lin_mag_kurt':           'redundant (Spearman>=0.95)',
    'A_lin_mag_mean':           'redundant (Spearman>=0.95)',
    'A_lin_mag_rms':            'redundant (Spearman>=0.95)',
    'A_lin_mag_std':            'redundant (Spearman>=0.95)',
    'A_lin_mag_val_ent':        'redundant (Spearman>=0.95)',
    'A_lin_mag_zcr':            'near-constant',
    'A_mag_corr_xy':            'near-constant',
    'A_mag_corr_xz':            'near-constant',
    'A_mag_corr_yz':            'near-constant',
    'A_mag_mag_mean':           'near-constant',
    'A_mag_mag_psd_0_2':        'near-constant',
    'A_mag_mag_psd_2_4':        'near-constant',
    'A_mag_mag_psd_4_8':        'near-constant',
    'A_mag_mag_std':            'near-constant',
    'A_mag_mag_val_ent':        'near-constant',
    'B_acc_mean':               'redundant (Spearman>=0.95)',
    'B_alt_mean':               'near-constant',
    'B_alt_range':              'near-constant',
    'B_alt_std':                'near-constant',
    'B_dist_total_m':           'redundant (Spearman>=0.95)',
    'B_n_valid_pairs':          'redundant (Spearman>=0.95)',
    'B_speed_max':              'redundant (Spearman>=0.95)',
    'B_speed_mean':             'redundant (Spearman>=0.95)',
    'B_speed_p25':              'redundant (Spearman>=0.95)',
    'B_speed_p50':              'redundant (Spearman>=0.95)',
    'B_stop_regularity':        'too-sparse (>80% NaN GPS-present)',
    'C_bus_stops_flag':         'redundant (Spearman>=0.95)',
    'C_osm_subway_prop':        'near-constant',
    'C_subway_stations_flag':   'near-constant',
    'C_subway_stations_mean':   'near-constant',
    'D_gap_fraction':           'redundant (Spearman>=0.95)',
}
